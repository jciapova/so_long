...
/*   Updated: 2023/07/06 14:31:15 by janka            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void   move_w(t_program *start, int x, int y)
{
	...
	if (start->map_data[y - 1][x] == 'E' && start->collected == start->collectibles_count)
	{	
		ft_printf("You won!\n");
		exit(0);
	}
...
void	move_a(t_program *start, int x, int y)
{
	...
	if (start->map_data[y][x - 1] == 'E' && start->collected == start->collectibles_count)
	{	
		ft_printf("You won!\n");
		exit(0);
	}
